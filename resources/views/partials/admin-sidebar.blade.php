...
$nav = [
    ...
    [
        'label' => 'People',
        'icon' => 'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3-3.87m6-1.13a4 4 0 10-4-4 4 4 0 004 4z',
        'can' => null,
    ...
    ['label' => 'Jobs', 'route' => 'admin.jobs.index', 'icon' => 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 012-2h-4a2 2 0 012 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2 2z', 'can' => 'jobs.view'],
    ...
    ['label' => 'Pages', 'route' => 'admin.pages.index', 'icon' => 'M9 12h6m-6 4h6m2 4h4M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z', 'can' => 'pages.view'],
    ...
    ['label' => 'Messages', 'route' => 'admin.messages.index', 'icon' => 'M3 8l9 6 9-6M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 0v10a2 2 0 002 2z', 'can' => 'messages.view'],
    ...
    ['label' => 'FAQs', 'route' => 'admin.faqs.index', 'icon' => 'M8 10h.01M12 10h.01M16 10h.01M9 16h6m-9 5h12a2 2 0 002-2V5a2 2 0 00-2-2H6a2 2 0 00-2 0v14a2 2 0 002 2z', 'can' => 'faqs.view'],
    ...
    ['label' => 'Settings', 'route' => 'admin.settings.edit', 'icon' => 'M10.3 4.3a2 2 0 013.4 0l.5 1a2 2 0 002.3 1l1-.3a2 2 0 012.4 2.4l-.3 1a2 2 0 001 2.3l1 .5a2 2 0 010 3.4l-1 .5a2 2 0 00-1 2.3l.3 1a2 2 0 01-2.4 2.4l-1-.3a2 2 0 00-2.3 1l-.5 1a2 2 0 01-3.4 0l-.5-1a2 2 0 00-2.3-1l-1 .3a2 2 0 01-2.4-2.4l.3-1a2 2 0 00-1-2.3l-1-.5a2 2 0 010-3.4l1-.5a2 2 0 001-2.3l-.3-1A2 2 0 016.5 6l1 .3a2 2 0 002.3-1zM12 15a3 3 0 100-6 3 3 0 010 6z', 'can' => 'settings.view'],
